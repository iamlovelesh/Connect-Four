...
var player1Color = 'rgb(255, 179, 0)';
...
function checkBottom(colIndex) {
  ...
  for (var row = 5; row > -1; row--) {
    ...
    if (colorReport === 'rgb(28, 33, 46)') {
      return row
    }
  }
}
function colorMatchCheck(one,two,three,four){
  return (one===two && one===three && one===four && one !== 'rgb(28, 33, 46)' && one !== undefined);
}
...
$('.playboard button').on('click',function() {
